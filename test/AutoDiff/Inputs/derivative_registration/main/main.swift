...
extension FunctionWithPrivateDerivativesInSeprateExtensions {
  @derivative(of: f)
  static private func f(_ x: Float) -> (value: Float, pullback: (Float) -> Float) {
...
// TODO(TF-XXXX): "a derivative already exists for 'f'" should not happen.
// // Extension2
// extension FunctionWithPrivateDerivativesInSeprateExtensions {
//   @derivative(of: f)
//   static private func f(_ x: Float) -> (value: Float, pullback: (Float) -> Float) {
